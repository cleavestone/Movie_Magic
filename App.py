...
@st.cache_resource
def load_database():
    uri = r"C:\Users\Hp\Desktop\movie_recommender\App\data\movies_lancedb"  # Replace with your actual LanceDB URI
...
def main():
    ...
    st.sidebar.image(r"C:\Users\Hp\Desktop\movie_recommender\App\static\moviees.jpg", caption="Your Movie Partner", use_container_width=True)
    st.sidebar.markdown("---")
